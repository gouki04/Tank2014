...
#define TERRAIN_ALLOWANCE 5.f
    ...
    MapElemVec MapCollideMgr::getCollideElemByMap( MapElement *elem, const cocos2d::Rect &aabb )
    {
    ...
    MapElemVec MapCollideMgr::getBlockElemByMap( MapElement *elem, const cocos2d::Rect &aabb ) {
    ...
    bool MapCollideMgr::isBlock( const cocos2d::Rect &aabb ) {
    ...
    bool MapCollideMgr::blockCheck( MapElement *elem, const cocos2d::Rect &aabb ) {
        return true;
    }
}
